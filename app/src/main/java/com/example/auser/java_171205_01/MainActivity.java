...
// 取到手機地點後的程式碼
    ...
    public void btn1(View v){
        ...
        StringRequest request = new StringRequest("https://maps.googleapis.com/maps/api/elevation/json?locations=39.7391536,-104.9847034&key=AIzaSyB0-nCDq3Px2VCc5TxAYLnTCbdn2HpIgsQ",
...
//                        double result = obj1.getDouble("elevation");
    ...
    //利用Android內建的Geocoder的作法，使用上沒有Google的付費使用次數限制。
